 ...
 */
function Segment(p1, p2, _sf, _zi) {
	...
	/** Z-index of the segment */
	var zIndex = (_zi === undefined) ? 1 : _zi; 
	...
	/**
	 *	Retrieves the Z-Index associated to the segment.
	 *	@return 	int		the z-index associated to the segment.
	 */
